...
interface ngToastrDisplayMethod {
	/**
	* Create a toast
	*
...
interface ngToastr {
	...
	*/
	error: ngToastrDisplayMethod;
	/**
	* Create an info toast
	*/
	info: ngToastrDisplayMethod;
	/**
	* Create an options object
	*/
	options: ngToastrOptions;
	/**
	* Create a success toast
	*/
	success: ngToastrDisplayMethod;
	/**
	* Create a warning toast
	*/
	warning: ngToastrDisplayMethod;
	/**
	* Get toastr version 
	*/
	version: string;
